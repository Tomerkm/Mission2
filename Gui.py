...
Button(iframe2,text="convert to csv",background="red",relief=SOLID,command = lambda:Interface_Function.Valid_Input(Dater.get(),Timer.get(),latitude.get(),longtitude.get(),Number_of_satellites_being_tracked.get())).pack(side=TOP,padx=0)
